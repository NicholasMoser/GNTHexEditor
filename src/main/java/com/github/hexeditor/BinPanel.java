...
public class BinPanel extends JPanel implements ActionListener, ItemListener, CaretListener, MouseListener
{
	...
	private JPanel findPanel()
	{
		...
		this.fJTF[0].setPreferredSize(new Dimension(
				this.fJCB[0].getPreferredSize().width + this.fJCB[1].getPreferredSize().width
						+ this.fJCB[2].getPreferredSize().width + this.fJCB[3].getPreferredSize().width,
	...
	private void checkFindEntry()
	{
		...
		} else
		{
			...
			if (var22 < 5 && !var19.startsWith("0x") && !var19.startsWith("Ox") && !var19.startsWith("ox"))
			{
				...
				BigDecimal var4 = var22 == 0 ? BigDecimal.valueOf(-32768L)
						: (var22 == 1 ? BigDecimal.valueOf(-2147483648L)
								: (var22 == 2 ? BigDecimal.valueOf(Long.MIN_VALUE)
