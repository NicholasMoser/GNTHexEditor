...
class SlaveModule extends Thread implements ActionListener {
		...
		if (var1.getSource() == this.timer) {
			...
			if (var9 != null && 0 < var9.length()) {
				...
				if (0 < var12.size()) {
					...
					if (var9.equals("-goto") && var12.size() == 2) {
					...
					} else if ((var9.equals("-Mark") || var9.equals("-mark") || var9.equals("-delmark")
							|| var9.equals("-delMark")) && 1 < var12.size()) {
						for (var4 = 1; var4 < var12.size(); ++var4) {
							try {
								...
								} else if (var9.equals("-mark") && !this.hexV.markV.contains(var8)) {
									this.hexV.markV.add(var8);
						...
						if (var2 = (var9.length() & 3) == 0) {
							...
							while (var4 < var9.length() - 3 && var2) {
								...
								for (var5 = 0; var5 < 4 && var2; ++var5) {
									...
									var6 = (var6 << 4) + (long) var16 - (long) (48 <= var16 && var16 <= 57 ? 48 : 55);
									++var4;
								}
